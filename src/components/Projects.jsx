...
import proj2 from "../assets/Image1.jpg";
import proj3 from "../assets/Image1.jpg";
    ...
    const projects =[
        {
            id: 1,
            image: proj1,
            title:'Opsie Software Solutions Website',
            desc: 'Start Up Company',
            tech: ['React Typescript', 'Tailwind CSS']
        },
        {
            id: 2,
            image: proj2,
            title:'GAHR Consultancy',
            desc: 'HR Website for Opsie',
            tech: ['React Typescript', 'Tailwind CSS']
        },
        {
            id: 1,
            image: proj3,
            title:'Opsync Messaging App',
            desc: 'Messaging App',
            ...
            {projects.map((project) => (
                ...
                transition-all duration-300'>
                    ...
                    <div className='p-4'>
                        ...
                        text-white group-hover:text-primary transition-color'>
                            {project.title}
                        </h3>
